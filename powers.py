...
class Powers:
    def __init__(self, power_id):
        self.stats = DB.get_document('powers/power_' + power_id + '.json')
    ...
    def average_dps(self, hero_id):
        hero = DB.get_document('heroes/' + hero_id + '.json')
...
class PhysicalPowers(Powers):
    def average_dps(self, hero_id):
        hero = DB.get_document('heroes/' + hero_id + '.json')

        dmg_percent = hero.offensive_stats.physical_base_damage + \
                      self.dmg_rating_to_percent(hero.offensive_stats.physical_damage_rating)


class EnergyPowers(Powers):
    def average_dps(self, hero_id):
        hero = DB.get_document('heroes/' + hero_id + '.json')

        dmg_percent = hero.offensive_stats.energy_base_damage + \
...
class EnergyPowers(Powers):
    def average_dps(self, hero_id):
        ...
        dmg_percent = hero.offensive_stats.mental_base_damage + \
...
class EnergyPowers(Powers):
    def average_dps(self, hero_id):
        ...
        dmg_percent = hero.offensive_stats.ranged_base_damage + \
...
class EnergyPowers(Powers):
    def average_dps(self, hero_id):
        ...
        dmg_percent = hero.offensive_stats.melee_base_damage + \
...
class EnergyPowers(Powers):
    def average_dps(self, hero_id):
        ...
        dmg_percent = hero.offensive_stats.summoned_ally_damage
